...
<nav class="bg-slate-50 dark:bg-slate-900 flex justify-between items-center w-full px-12 h-16 max-w-none fixed top-0 z-50">
    ...
    <div class="hidden md:flex items-center gap-8 font-public-sans text-sm tracking-tight">
        ...
        <a class="text-green-700 dark:text-green-400 font-semibold border-b-2 border-green-700 dark:border-green-400 pb-1" href="#">Ofertas de Empleo</a>
        ...
        <a class="text-slate-600 dark:text-slate-400 hover:text-green-600 dark:hover:text-green-300 transition-colors" href="#">Graduados</a>
    </div>
...
<main class="mt-16 lg:ml-64 flex-grow p-12">
    ...
    <form action="procesar.php" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div class="md:col-span-2 bg-surface-container-lowest p-6 rounded-xl flex items-center gap-4">
            <span class="material-symbols-outlined text-outline">search</span>
            <input name="query" class="w-full bg-transparent border-none focus:ring-0 text-on-surface placeholder:text-outline-variant" placeholder="Buscar por cargo o empresa..." type="text"/>
        </div>
        <div class="bg-surface-container p-6 rounded-xl flex items-center justify-between">
            <select name="pais" class="bg-transparent border-none w-full text-sm font-semibold focus:ring-0 appearance-none cursor-pointer">
                <option value="co">Colombia</option>
                <option value="int">Internacional</option>
            </select>
            <span class="material-symbols-outlined">expand_more</span>
        </div>
        <button type="submit" class="bg-primary text-on-primary p-6 rounded-xl flex items-center justify-center font-bold transition-all hover:opacity-90 cursor-pointer border-none">
            Aplicar Filtros
        </button>
    </form>

    <div class="bg-surface-container-lowest rounded-xl overflow-hidden overflow-x-auto">
...
<footer class="bg-slate-50 dark:bg-slate-900 full-width py-8 border-t border-slate-200 dark:border-slate-800 w-full px-12 flex flex-col md:flex-row justify-between items-center gap-4">
    ...
    <div class="flex gap-6 font-public-sans text-xs uppercase tracking-widest">
        ...
        <a class="text-slate-400 hover:text-green-700 transition-colors" href="#">Soporte de Contacto</a>
    </div>
</footer>
